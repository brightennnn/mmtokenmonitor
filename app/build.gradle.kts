...
android {
    namespace = "io.github.brightennnn.mmtokenmonitor"
    compileSdk = 35
...
dependencies {
    ...
    // Compose BOM — 2024.10.00 (Material3 1.3.0+ for MD3E support)
    ...
    // Material Components (for XML theme attrs like ?attr/colorPrimary)
    ...
    // Glance AppWidget (Material 3 + Monet support) — 1.1.0
